  ...
  return (
    <>
      <div className="dark:bg-[#192734]">
        <div className="maindiv p-3 w-4/5 m-auto mt-8 bg-white-800 border-2 dark:bg-[#192734]	border-slate-400	border-solid	rounded-lg	">
          {" "}
          <div className="secounddiv  w-4/5 m-auto mt-4 bg-white-800 justify-around flex flex-col">
            <div>
              <h2 className="text-2xl	 hover:text-amber-600  font-bold text-center">{`Exam is completed your score is ${score} out of ${9}`}</h2>
            </div>
